            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="@if ($person->image > 1)
                            {{ 'assets/images/user/'.$person->image }}
                            @else
                                {{ 'assets/images/user/no_img.jpg' }}
                            @endif" class="img-radius" alt="User-Profile-Image">
                            <span>{{ $person->name }}</span>
                            
                        </div>
                        <ul class="pro-body">
                            <li>
                                <form action="user-profile.html" class="dropdown-item">
                            ...
                            <li>
                                <form action="email_inbox.html" class="dropdown-item">
                                    <button type="submit" style="border: none; background: none;">
